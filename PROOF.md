...
| Deployment | Publish verified services hub and operations continuation | `main`, preview and authorised staging hostname | Pending commit, SHA match, Vercel Git deployment, HTTPS smoke | Local continuation pass is verified and ready to publish. | Git/Vercel release record above | 2026-08-09 23:30 UTC | Pending |
