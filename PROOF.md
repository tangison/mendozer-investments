...
| Deployment | Publish the verified completion pass through GitHub/Vercel | `main`, preview and authorised staging hostname | Pending commit, SHA match, Vercel Git deployment, preview/staging HTTPS check | Local completion pass is verified and ready to publish. | Git/Vercel release record above | 2026-08-09 23:12 UTC | Pending |
