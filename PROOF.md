...
| Deployment | Publish amended verified commit through existing GitHub/Vercel connection | `main`, `mendozer-tangison-preview.vercel.app` | Pending commit/push, Vercel Git deployment, TLS and URL check | Local amendment is verified and ready to publish. | Git/Vercel release record above | 2026-08-09 17:52 UTC | Pending |
