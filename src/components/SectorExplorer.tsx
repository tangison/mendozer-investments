      ...
      <div className="sector-explorer__desktop">
        ...
        <div aria-labelledby={`${idPrefix}-tab-${activeIndex}`} className="sector-explorer__panel" id={`${idPrefix}-panel`} role="tabpanel">
          ...
          <div className="sector-explorer__detail">
            ...
            <Link aria-label={`Explore ${activeSector.title}`} className="text-link" href={`/sectors/${activeSector.slug}`}>Explore this direction <ArrowIcon /></Link>
          </div>
        </div>
      </div>
        ...
        {sectors.map((sector) => (
          <details className="sector-explorer__accordion" key={sector.slug}>
            ...
            <div>
              ...
              <Link aria-label={`Explore ${sector.title}`} className="text-link" href={`/sectors/${sector.slug}`}>Explore this direction <ArrowIcon /></Link>
            </div>
          </details>
        ))}
      </div>
