...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    url: "/sectors",
    images: [{ url: "/og/home.jpg", width: 1200, height: 630, alt: "Mendozer Investments sectors" }],
  },
};
    ...
    <>
      ...
      <section className="section sector-hub">
        <div className="site-container">
          ...
          />
          <Reveal><SectorExplorer idPrefix="sector-directory" label="Mendozer sector directory" /></Reveal>
        </div>
      </section>
