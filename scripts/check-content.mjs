...
if (existsSync(resolve(root, "public/media/mendozer-hero-motion.mp4")) || existsSync(resolve(root, "public/media/mendozer-hero-motion.webm")) || existsSync(resolve(root, "public/media/mendozer-hero-motion-mobile.mp4")) || existsSync(resolve(root, "public/media/mendozer-hero-motion-mobile.webm"))) failures.push("Retired secondary motion loops must stay deleted (hero desert-loop is the only video)");
