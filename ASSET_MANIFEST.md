...
## Windhoek satellite office announcement: 2026-09-03

| Asset | Use | Status |
|---|---|---|
| `/og/windhoek-office.png` | Deterministic social preview for `/blog/mendozer-windhoek-satellite-office` | Generated by `scripts/generate-og.py` from a real supplied photo background (road-works-2.jpg) plus locked brand tokens |
