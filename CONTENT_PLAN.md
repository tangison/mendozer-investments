...
- **Verified:** explicitly supported by the source package.
- **Working / generic:** short descriptive copy allowed by the brief, but not a Mendozer-specific performance claim.
- **Placeholder:** needs client approval or source material before it can be represented as final factual content.
...
| Section | Content | Status |
|---|---|---|
| Hero | “A group built for the whole picture.” | Working / generic |
...
|---|---|---|
| `construction` | Construction & Infrastructure | Supplied construction-building / road-work context, generic caption |
